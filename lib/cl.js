...
function withEvents(eventWaitList, f) {
    ...
    check(f(eventWaitList ? eventWaitList.length : 0, pEvents, pEvent))
...
CLProgram.prototype.build = function(name, options) {
    check(opencl.clBuildProgram(this.program, 0, null, options || '', null, null));
};
