...
void OpenCL_init(v8::Handle<v8::Object > _target_) {
	...
	_target_->Set(v8::String::NewSymbol("CL_MEM_HOST_WRITE_ONLY"), v8::Integer::New((1 << 7)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MEM_WRITE_ONLY"), v8::Integer::New((1 << 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_TYPE_CUSTOM"), v8::Integer::New((1 << 4)));
	_target_->Set(v8::String::NewSymbol("CL_MEM_USE_HOST_PTR"), v8::Integer::New((1 << 3)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_AFFINITY_DOMAIN_L3_CACHE"), v8::Integer::New((1 << 2)));
	...
	_target_->Set(v8::String::NewSymbol("CL_INT_MIN"), v8::Integer::New((-2147483647 - 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_SCHAR_MIN"), v8::Integer::New((-127 - 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_AFFINITY_DOMAIN_L2_CACHE"), v8::Integer::New((1 << 3)));
	...
	_target_->Set(v8::String::NewSymbol("CL_FP_CORRECTLY_ROUNDED_DIVIDE_SQRT"), v8::Integer::New((1 << 7)));
	...
	_target_->Set(v8::String::NewSymbol("CL_KERNEL_ARG_TYPE_CONST"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MEM_HOST_NO_ACCESS"), v8::Integer::New((1 << 9)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MIGRATE_MEM_OBJECT_HOST"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_KERNEL_ARG_TYPE_VOLATILE"), v8::Integer::New((1 << 2)));
	...
	_target_->Set(v8::String::NewSymbol("CL_FP_DENORM"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_AFFINITY_DOMAIN_L4_CACHE"), v8::Integer::New((1 << 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_FP_SOFT_FLOAT"), v8::Integer::New((1 << 6)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MEM_READ_WRITE"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MEM_COPY_HOST_PTR"), v8::Integer::New((1 << 5)));
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_TYPE_CPU"), v8::Integer::New((1 << 1)));
	_target_->Set(v8::String::NewSymbol("CL_FP_INF_NAN"), v8::Integer::New((1 << 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_CHAR_MIN"), v8::Integer::New((-127 - 1)));
	_target_->Set(v8::String::NewSymbol("CL_MEM_HOST_READ_ONLY"), v8::Integer::New((1 << 8)));
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_TYPE_GPU"), v8::Integer::New((1 << 2)));
	...
	_target_->Set(v8::String::NewSymbol("CL_QUEUE_PROFILING_ENABLE"), v8::Integer::New((1 << 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_QUEUE_OUT_OF_ORDER_EXEC_MODE_ENABLE"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_AFFINITY_DOMAIN_NEXT_PARTITIONABLE"), v8::Integer::New((1 << 5)));
	...
	_target_->Set(v8::String::NewSymbol("CL_FP_FMA"), v8::Integer::New((1 << 5)));
	...
	_target_->Set(v8::String::NewSymbol("CL_EXEC_NATIVE_KERNEL"), v8::Integer::New((1 << 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MIGRATE_MEM_OBJECT_CONTENT_UNDEFINED"), v8::Integer::New((1 << 1)));
	_target_->Set(v8::String::NewSymbol("CL_EXEC_KERNEL"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_TYPE_ACCELERATOR"), v8::Integer::New((1 << 3)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MAP_READ"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_FP_ROUND_TO_ZERO"), v8::Integer::New((1 << 3)));
	_target_->Set(v8::String::NewSymbol("CL_PROGRAM_BINARY_TYPE_LIBRARY"), v8::Integer::New(0x2));
	_target_->Set(v8::String::NewSymbol("CL_MEM_READ_ONLY"), v8::Integer::New((1 << 2)));
	...
	_target_->Set(v8::String::NewSymbol("CL_KERNEL_ARG_TYPE_RESTRICT"), v8::Integer::New((1 << 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MEM_ALLOC_HOST_PTR"), v8::Integer::New((1 << 4)));
	...
	_target_->Set(v8::String::NewSymbol("CL_FP_ROUND_TO_INF"), v8::Integer::New((1 << 4)));
	...
	_target_->Set(v8::String::NewSymbol("CL_SHRT_MIN"), v8::Integer::New((-32767 - 1)));
	_target_->Set(v8::String::NewSymbol("CL_FP_ROUND_TO_NEAREST"), v8::Integer::New((1 << 2)));
	_target_->Set(v8::String::NewSymbol("CL_INVALID_KERNEL_DEFINITION"), v8::Integer::New(-47));
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_TYPE_DEFAULT"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_AFFINITY_DOMAIN_NUMA"), v8::Integer::New((1 << 0)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MAP_WRITE_INVALIDATE_REGION"), v8::Integer::New((1 << 2)));
	...
	_target_->Set(v8::String::NewSymbol("CL_MAP_WRITE"), v8::Integer::New((1 << 1)));
	...
	_target_->Set(v8::String::NewSymbol("CL_DEVICE_AFFINITY_DOMAIN_L1_CACHE"), v8::Integer::New((1 << 4)));
